    ...
    <>
      {isOpen && (
        <m.div
          ...
          className="fixed bg-gray-500/20 backdrop-blur-[2px] z-10 h-screen w-screen items-center"
        >
          <m.div
            initial="hidden"
            animate="visible"
            variants={variants}
            className="absolute bg-gradient-to-br from-bk-200/90 to-gray-900/90 w-[450px] right-0 h-[100dvh] z-20 shadow-xl text-white p-10 backdrop-blur-sm "
          >
