  ...
  return (
    <>
      <div className="absolute flex justify-center items-center w-screen h-screen bg-gray-700/20 backdrop-blur-[2px] z-20">
        <div className="bg-white p-10 relative flex flex-col rounded-2xl bg-transparent bg-clip-border text-gray-700 shadow-xl">
          {/* Close Button */}
          <div classNameName="absolute top-0 left-0 flex justify-center items-center rounded-full h-12 w-12 -m-4">
            <XCircleIcon classNameName="text-bk-50 hover:text-bk-150 transition-all" />
          </div>
          ...
          <form className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
            <div className="mb-4 flex flex-col gap-6">
              ...
              <Select label="Select Priority" color={"border-bk-250"}>
                <Option>Low</Option>
            ...
            <button
              className="mt-6 block w-full select-none rounded-lg bg-bk-200 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-bk-200/20 transition-all hover:shadow-lg hover:shadow-bk-250/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
              type="button"
